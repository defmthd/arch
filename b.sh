...
pacman -S htop git grub grub-btrfs efibootmgr networkmanager network-manager-applet dialog wpa_supplicant mtools dosfstools ntfs-3g base-devel linux-headers os-prober
...
pacman -S xorg xorg-xinit openbox nitrogen mmaker obconf lxappearance-obconf
...
yay -Syu
yay -S ly google-chrome github-desktop 1password visual-studio-code-bin slack-desktop ttf-windows ttf-font-awesome nerd-fonts-victor-mono nerd-fonts-fantasque-sans-mono noto-fonts-emoji
